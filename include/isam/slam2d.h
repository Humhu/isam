...
namespace isam {
	...
	public:
		...
		typedef std::shared_ptr<Point2d_Factor> Ptr;
	...
	public:
		...
		typedef std::shared_ptr<Pose2d_Factor> Ptr;
	...
	public:
		...
		typedef std::shared_ptr<Pose2d_Pose2d_Factor> Ptr;
	...
	public:
		...
		typedef std::shared_ptr<Pose2d_Point2d_Factor> Ptr;
