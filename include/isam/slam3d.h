...
namespace isam {
	...
	public:
		...
		typedef std::shared_ptr<Point3dT_Node> Ptr;
	...
	public:
		...
		typedef std::shared_ptr<Pose3d_Factor> Ptr;
	...
	public:
		...
		typedef std::shared_ptr<Pose3d_Pose3d_Factor> Ptr;
	...
	public:
		...
		typedef std::shared_ptr<Pose3d_Point3d_Factor> Ptr;
